@extends('layouts.app', ['title' => 'Manage ContactDetail'])
        ...
        <div class="card-body pt-9 pb-0">
            ...
            <div class="d-flex overflow-auto h-55px">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{route('Contact')}}">Contact </a>
                    </li>
                      <li class="nav-item">
                ...
                <table id="kt_profile_overview_table"
                    ...
                    <thead class="fs-7 text-gray-400 text-uppercase">
                        <tr>
                            ...
                            <th class="min-w-150px">Office Title</th>
                            <th class="min-w-250px">Description</th>
                            <th class="min-w-30px">State</th>
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td>
                                   @php $dd=DB::table('state')->where('id',$data->state)->first();
                                                @endphp {{$dd->title}}   
                               ...
                               <td>
                                    <a href="{{ route('editContactDetail', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                   <!--  @if ($data->status == 1)
                                        <a href="{{ route('hideContactDetail', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideContactDetail', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif -->
                                    <a href="{{ route('deleteContactDetail', ['id' => $data->id]) }}"
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addContactDetail') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                                <div class="row">
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Office Title</span>
                                    ...
                                    <div class="w-100">
                                       <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">List Location</span>
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="Specify your unique app name"></i>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea id="editors" style="height: 100px;" type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="description"  placeholder="list locations"
                                                        > </textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
