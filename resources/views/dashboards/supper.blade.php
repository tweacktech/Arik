                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10"
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-4 fw-bolder">Manage Web</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        ...
                        <div class="card-toolbar">
                            ...
                            <button class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary"
                                data-kt-menu-placement="bottom-end" data-kt-menu-trigger="click" type="button">
                        ...
                        <div class="timeline-label">
                            @foreach ($activities as $activity)
                                ...
                                <div class="timeline-item">
                                    ...
                                    <!--end::Badge-->
                                    <!--begin::Text-->
                                    <div class="fw-mormal timeline-content text-muted ps-3">{{ $activity->activity }}
                                    </div>
                                    <!--end::Text-->
                                </div>
                            @endforeach
                                        ...
                                        <tbody>
                                          ...
                                          @foreach($data as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary"
                                                            href="#">
                                                            ...
                                                            <span class="svg-icon svg-icon-2">
                                                                <svg fill="none" height="24"
                                                                    ...
                                                                    <rect fill="black" height="2"
                                                                        opacity="0.5" rx="1"
                                                                        transform="rotate(-180 18 13)" width="13"
                                                                        x="18" y="13" />
                                                                    <path
