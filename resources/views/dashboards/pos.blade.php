...
<html lang="en">
	...
	<head><base href="../../">
		...
		<link href="https://stockmgt.gapaautoparts.com/public/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="https://stockmgt.gapaautoparts.com/public/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Global Stylesheets Bundle-->
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body style="overflow:hidden" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		<!--begin::Main-->
		<!--begin::Root-->
		<div class="d-flex flex-column flex-root">
			<!--begin::Page-->
			<div class="page d-flex flex-row flex-column-fluid" style="background-color:#ccc">
				<!--begin::Aside-->
				<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					<!--begin::Logo-->
					<div class="aside-logo flex-column-auto pt-5 pt-lg-20" id="kt_aside_logo" style="background:#fff;">
						
							<img style="width:100%" alt="Logo" src="https://gapaautoparts.com/uploads/b79logo11__1_-removebg-preview.png" />
						...
						<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
								<div class="menu-item py-3">
									<a class="menu-link" href="/home" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div class="menu-item py-3">
									<a class="menu-link" href="../../demo9/dist/index.html" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2x">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						...
						<div class="d-flex flex-center w-100 scroll-px" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="Quick actions">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
								...
								<div class="menu-item px-3">
									<div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">Logout</div>
								</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="stepper stepper-links d-flex flex-column pt-5" id="kt_create_account_stepper">
										...
										<form class="mx-auto mw-900px w-100 pt-5 pb-10" novalidate="novalidate" id="kt_create_account_form">
											<!--begin::Step 1-->
											<div class="current" data-kt-stepper-element="content">
												<!--begin::Wrapper-->
												<div class="w-100">
												<!--begin::Title-->
														<h2 class="fw-bolder d-flex align-items-center p-2 pl-20" style="color:#492F92;">Hi, <b>{{ Auth::user()->name }}</b>
														...
														<!--end::Title-->
														<!--begin::Notice-->
														<div class="text-muted fw-bold fs-6">What do you want to do?
														</div>
														<!--end::Notice-->
													<!--begin::Heading-->
													<div class="pb-10 pb-lg-15" style="background: #492F92">
														<p class="pt-2" ><center style="color:#fff">Today's Sales</center></p>
														
														<p><center><h1 style="color:#fff; size:38px; line-height: 45.99px">
                                                         
                                                          @php
                                                          	$sales = DB::table('store_stock_transactions')
                                                          	->where('store_id', 1)
                                                          ->where('type', 'sold')
                                                          	->Sum('sub_total');
                                                          @endphp
                                                          NGN {{number_format($sales, 2)}}
			...
			<a href="/make-sales"  style="background: yellow;border: 1px solid #FFFFFF;" class="btn btn-outline btn-outline-dashed btn-outline-default p-1 d-flex align-items-center mb-10" >
																	...
																	<span class="d-block fw-bold text-start">
																		...
																		<span class="text-muted fw-bold fs-6">Make Sales</span>
																	</span>
																	<!--end::Info-->
																</a>
																<!--end::Option-->
		...
		<a href="/sales-history" style="background: yellow;border: 1px solid #FFFFFF;" class="btn btn-outline btn-outline-dashed btn-outline-default p-1 d-flex align-items-center mb-10" for="kt_create_account_form_account_type_personal">
																	<!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
																	<span class="svg-icon svg-icon-3x me-5">
																		<span class="svg-icon svg-icon-3x me-5">
																		<img src="sales.png" />
																	...
																	<!--begin::Info-->
																	<span class="d-block fw-bold text-start">
																		<span class="text-dark fw-bolder d-block fs-4 mb-2">Sales History</span>
																	</span>
																	<!--end::Info-->
																</a>
																<!--end::Option-->
															...
															<div class="col-lg-4">
																...
																<label style="background: yellow;border: 1px solid #FFFFFF;" class="btn btn-outline btn-outline-dashed btn-outline-default p-1 d-flex align-items-center" for="kt_create_account_form_account_type_corporate">
																	...
																	<!--begin::Info-->
																	<span class="d-block fw-bold text-start">
																		<span class="text-dark fw-bolder d-block fs-4 mb-2">Retured</span>
															...
															<div class="col-lg-4">
																...
																<a href="/view_stock" class="btn btn-outline btn-outline-dashed btn-outline-default p-1 d-flex align-items-center" for="kt_create_account_form_account_type_corporate">
																	<!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
																	<span class="svg-icon svg-icon-3x me-5">
																		<span class="svg-icon svg-icon-3x me-5">
																		<img src="stock.png" />
																	...
																	<!--begin::Info-->
																	<span class="d-block fw-bold text-start">
																		<span class="text-dark fw-bolder d-block fs-4 mb-2">Stock</span>
															...
															<div class="col-lg-4">
																...
																<a href="/getTotalSales" class="btn btn-outline btn-outline-dashed btn-outline-default p-1 d-flex align-items-center" for="kt_create_account_form_account_type_corporate">
																	<!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
																	<span class="svg-icon svg-icon-3x me-5">
																		<span class="svg-icon svg-icon-3x me-5">
																		<img src="sales.png" />
																	...
																	<!--begin::Info-->
																	<span class="d-block fw-bold text-start">
																		<span class="text-dark fw-bolder d-block fs-4 mb-2">Total Sales</span>
															...
															<div class="col-lg-4">
																...
																<a href="/print" class="btn btn-outline btn-outline-dashed btn-outline-default p-1 d-flex align-items-center" for="kt_create_account_form_account_type_corporate">
																	<!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
																	<span class="svg-icon svg-icon-3x me-5">
																		<span class="svg-icon svg-icon-3x me-5">
																		<img src="pos.png" />
																	...
																	<!--begin::Info-->
																	<span class="d-block fw-bold text-start">
																		<span class="text-dark fw-bolder d-block fs-5 mb-2">Print Recipt</span>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
		...
		<!--end::Scrolltop-->
		<!--end::Main-->
		<script>var hostUrl = "https://stockmgt.gapaautoparts.com/public/assets/";</script>
		<!--begin::Javascript-->
		...
		<script src="https://stockmgt.gapaautoparts.com/public/assets/js/custom/modals/create-account.js"></script>
	...
	<script>
  function ready() {
	var username = localStorage.getItem("pos_token");
	
	if(username == "" || username == null ){
		//window.location.href = "POS/sales/index.html";
	}else{
  ...
  function getTodaySales(){
	...
	var dataString = 'username=' + username;
		...
		$.ajax({
			...
			url: "http://192.168.0.187/GAPA/API/getTodaySales.php",
			dataType: 'text',
			data: dataString,
			catch: false,
			success: function (result) {
				document.getElementById("today_sales").innerHTML= result;
			}
		});
  }
