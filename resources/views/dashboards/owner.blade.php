                ...
                <div class="row mb-5 mb-xl-8 g-5 g-xl-8">
                    ...
                    <div class="col-12">
                        <div class="card card-stretch">
                            <a href="{{route('manage-stock')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                                <span class="svg-icon svg-icon-3x mb-5">
                                    @php
                                    use Carbon\Carbon;
                                         $sales = DB::table('store_sales_items')
                                        ->where('status', '1')
                                        ->where('date', date('Y-m-d'))
                                        ->sum('total');

                                    @endphp
                                    N{{ number_format($sales, 2)}}
                                </span>
                                <!--end::Svg Icon-->
                                <span class="fs-8 fw-bolder">Today Total Store Sales</span>
                            </a>
                        </div>
                    </div>
                            ...
                            <a href="{{route('manage-stock')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                ...
                                <span class="svg-icon svg-icon-3x mb-5">
                                    @php
                                         ...
                                         $sales = DB::table('invoice_product')
                                        ->where('status', '1')
                                        ->where('date', date('Y-m-d'))
                                        ->sum('price');
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-8 fw-bolder">Today Invoice Sales</span>
                            </a>
                        </div>
                    </div>
                            ...
                            <a href="{{route('manage-stock')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                ...
                                <span class="svg-icon svg-icon-3x mb-5">
                                    @php
                                         ...
                                         $sales = DB::table('online_sales_items')
                                        ->where('status', '1')
                                        ->where('date', date('Y-m-d'))
                                        ->sum('total');
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-8 fw-bolder">Today Online Sales</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a href="{{route('manage-stock')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-5">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                                <span class="svg-icon svg-icon-3x mb-5">
                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a href="{{ route('getorder') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-5">
                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a href="{{ route('get_employees') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-5">
                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a href="{{ route('getcustomers_offline') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-5">
                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a href="{{ route('getmanufacturers') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-5">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
                                <span class="svg-icon svg-icon-3x mb-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path d="M21 10H13V11C13 11.6 12.6 12 12 12C11.4 12 11 11.6 11 11V10H3C2.4 10 2 10.4 2 11V13H22V11C22 10.4 21.6 10 21 10Z" fill="black" />
                    ...
                    <div class="col-6">
                        <div class="card card-stretch">
                            <a href="{{ route('getpurchases') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#" class="text-dark fw-bolder text-hover-primary fs-5">Warehouses</a>
                                ...
                                <!--begin:Menu-->
                                <div class="ms-1">
                                    <a class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" href="{{route('manage_warehouse')}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin:Title-->
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#" class="text-dark fw-bolder text-hover-primary fs-5">Stores</a>
                                ...
                                <!--begin:Menu-->
                                <div class="ms-1">
                                    <a href="{{ route('manage_stores') }}" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
