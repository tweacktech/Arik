<div class="menu-item py-3">
									<a class="menu-link" href="{{ route('manage_accounting') }}" title=" Accounts" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div class="menu-item py-3">
									<a class="menu-link" href="{{ route('invoicing') }}" title="Manage Invoicing" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon" style="background-color:#492F92; color:#fff">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2x">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
									<span class="menu-link" title="Manage Cars" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon" style="background-color:#492F92; color:#fff">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4" >
										<div class="menu-item">
											<div class="menu-content" >
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Cars</span>
											</div>
										</div>
										
										<div class="menu-item">
											<a class="menu-link" href="{{ route('getbrands') }}">
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('getcars') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ route('getcarmodels') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<!-- <div class="menu-item">
											<a class="menu-link" href="../../demo9/dist/account/security.html">
												...
												<span class="menu-title">Car Sub-Models</span>
											</a>
										</div> -->
								...
								<div class="menu-item py-3">
									<a class="menu-link" href="{{ route('messages') }}" title="Messages" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon" style="background-color:#492F92; color:#fff">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2x">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
									<span class="menu-link" title="Manage Reports" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon" style="background-color:#492F92; color:#fff">
											<!--begin::Svg Icon | path: icons/duotune/coding/cod001.svg-->
											<span class="svg-icon svg-icon-2x">
												<svg style="color:#fff;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										<div class="menu-item">
											<div class="menu-content">
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Manage Reports</span>
											</div>
										</div>
										<div class="menu-item">
