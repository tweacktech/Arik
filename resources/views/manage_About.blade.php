@extends('layouts.app', ['title' => 'Manage About'])
                ...
                <table id="kt_profile_overview_table"
                    ...
                    <thead class="fs-7 text-gray-400 text-uppercase">
                        <tr>
                            ...
                            <th class="min-w-30px">Number Aviat..</th>
                            <th class="min-w-50px">aviationIndustries</th>
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-5 position-relative">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/about/'.$data->image) }}" 
                                                 />
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                                ...
                                <td>
                                     {{$data->aviationIndustries}}

                                </td> 
                                 <td>
                                     {{$data->aviationIndustries_text}}
                               ...
                               <td>
                                    <a href="{{ route('editAbout', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                    @if ($data->status == 1)
                                        <a href="{{ route('hideAbout', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideAbout', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                   <!--  <a href="{{ route('deleteAbout', ['id' => $data->id]) }}"
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addAbout') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="title" placeholder="Enter Title"require />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="col-md-4">
                                       <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">AviationIndustries</span>
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="Specify your unique app name"></i>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                                <input  type="text"
                                                        ...
                                                        name="aviationIndustries_text"  placeholder=""
                                                        > 
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="col-md-4">
                                       <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">aviationIndustries Number</span>
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="Specify your unique app name"></i>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                                <input type="number" min="1" 
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="aviationIndustries"  placeholder=""
                                                        > 
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
