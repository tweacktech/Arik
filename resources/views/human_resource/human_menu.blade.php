<div class="ps-xl-6 d-flex  justify-content-between" style="overflow-x: scroll;">
    <!--begin::Engage widget 1-->

    <a class="p-2" href="/home">
            ...
            <div class="col-md-12" style="display: flex">
                <div class="col-md-12 p-5">
                    <div class="container d-flex align-items-center ">
                        <h4 style="color:white;" class=me-3>View all Openings</h4>
                        <div>
                            <svg style="height: 30px;" viewBox="0 0 1024 1024" class="icon" version="1.1"
    ...
    <a class="p-2" href="/add-listings">
        ...
        <div class="card-body d-flex flex-column justify-content-center"
            ...
            <div class="col-md-12" style="display: flex">
                <div class="col-md-12 p-5">
                    <div class="container  d-flex align-items-center">
                        <h4 style="color:white;" class="me-3">Create Openings</h4>
                        <div>
                            <svg style="height: 30px;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                id="create-note" class="icon glyph" fill="#ffffff" stroke="#ffffff">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path
    ...
    <!--begin::Body-->
    <a href="/all_applicants" class="p-2">
        ...
        <div class="card-body d-flex flex-column justify-content-center"
            ...
            <div class="col-md-12" style="display: flex">
                <div class="col-md-12 p-5">
                    <div class="container  d-flex align-items-center">
                        <h4 style="color:white;" class="me-3">All Applicants</h4>
                        <div>
                            <svg style="height: 30px;" viewBox="0 0 24 24" fill="none"
    ...
    <a href="/all_job_category" class="p-2">
        ...
        <div class="card-body d-flex flex-column justify-content-center"
            ...
            <div class="col-md-12" style="display: flex">
                <div class="col-md-12 p-5">
                    <div class="container  d-flex align-items-center">
                        <h4 style="color:white;" class="me-3">Job Categories</h4>
                        <div>
                            <svg style="height: 30px;" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    ...
    <a href="/all_job_department" class="p-2">
        ...
        <div class="card-body d-flex flex-column justify-content-center"
            ...
            <div class="col-md-12" style="display: flex">
                <div class="col-md-12 p-5">
                    <div class="container  d-flex align-items-center">
                        <h4 style="color:white;" class="me-3">Job Departments</h4>
                        <div>
                            <svg style="height: 30px;" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    ...
    <a href="/all_users" class="p-2">
        ...
        <div class="card-body d-flex flex-column justify-content-center"
            ...
            <div class="col-md-12" style="display: flex">
                <div class="col-md-12 p-5">
                    <div class="container  d-flex align-items-center">
                        <h4 style="color:white;" class="me-3">All Users</h4>
                        <div>
                            <svg style="height: 30px;" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
