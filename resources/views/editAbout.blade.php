                            ...
                            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                                ...
                                <div class="flex-row-fluid py-lg-5 px-lg-15">
                                    ...
                                    <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                        method="POST" action="{{ route('updateAbout', ['id' => $update->id]) }}"
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            <div class="w-100">
                                                ...
                                                <img alt="Pic" src="{{ asset('public/about/'.$update->image) }}" />
                                                      </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input  type="text"
                                                        ...
                                                        value="{{ $update->aviationIndustries_text }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input  type="text"
                                                        ...
                                                        value="{{ $update->aviationIndustries }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
