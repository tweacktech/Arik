@extends('layouts.app', ['title' => 'Edit SpecialOffers'])
                            ...
                            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                                ...
                                <div class="flex-row-fluid py-lg-5 px-lg-15">
                                    ...
                                    <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                        method="POST" action="{{ route('updateSpecialOffers', ['id' => $update->id]) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <img alt="Pic" src="{{ asset('public/SpecialOffers/'.$update->image) }}" />
                                                      </div>
                                          ...
                                          <div class="row">
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="month"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="event_date"  min="YYYY-MM" max="YYYY-MM" placeholder="" value="{{ $update->event_date }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
										  ...
										  <div class="row">
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="price" placeholder="" value="{{ $update->price }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
