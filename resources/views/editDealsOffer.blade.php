@extends('layouts.app', ['title' => 'Edit Deals and offer'])
                            ...
                            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                                ...
                                <div class="flex-row-fluid py-lg-5 px-lg-15">
                                    ...
                                    <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                        method="POST" action="{{ route('updateDealsOffer', ['id' => $update->id]) }}"
        ...
        @endforeach
                                      ...
                                      <div class="row">
                                            <div class="w-100">
                                                ...
                                                <img alt="Pic" src="{{ asset('public/deals/'.$update->image) }}" />
                                                      </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="kid" placeholder="" value="{{ $update->kid }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="kid_title" placeholder="" value="{{ $update->kid_title }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                         ...
                                         <div class="row">
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                        <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/deals/'.$update->kid_image) }}" />
                                                      </div>
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="file"
                                                        class="form-control form-control-lg form-control-solid" min="100" name="kid_image" value="{{$update->kid_image}}"  />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <input type="color"
                                                        class="form-control form-control-lg form-control-solid"  
                                                        name="background_color" placeholder=""
