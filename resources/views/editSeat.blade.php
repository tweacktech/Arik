                            ...
                            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                                ...
                                <div class="flex-row-fluid py-lg-5 px-lg-15">
                                    ...
                                    <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                        method="POST" action="{{ route('updateSeat', ['id' => $update->id]) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <img alt="Pic" src="{{ asset('public/Seat/'.$update->icon) }}" />
                                                      </div>
                                           ...
                                           <div class="row">
                                            <div class="w-100">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                        <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/Seat/'.$update->image) }}" />
                                                      </div>
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <select type="text" class="form-control form-control-lg form-control-solid"
                                                name="category" placeholder=""require />
                                                  <option  value="{{ $update->category }}" >{{ $update->category }} Current</option>
