@extends('layouts.app', ['title' => 'Manage Seat'])
            ...
            <div class="d-flex overflow-auto h-55px">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{url('manage-SeatHeader')}}">Header  </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{url('editSeatFooter')}}">Footer  </a>
                    </li>
                    <li class="nav-item">
...
<script>
  ...
  <div class="modal fade" id="category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    <form method="POST" action="{{route('addSeatCat')}}" >
                         @csrf
                        <div class="row">
                                    <div class="w-100">
                                        <!--begin::Input group-->
    ...
    <tbody>
        @php
            $tata = DB::table('seat_cats')->paginate(5);
        @endphp
        @foreach($tata as $da)
        <tr>
            <td>{!! $da->title !!}</td>
            <td>
                <a href="{{ route('deleteSeatCat', ['id' => $da->id]) }}"
...
{{ $tata->links() }}
                ...
                <div class="card-toolbar ">
                    <a href="#" class="btn btn-flex btn-success" data-bs-target="#category" data-bs-toggle="modal">
                        Seat Category
                    </a>
                </div>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-5 position-relative">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/Seat/'.$data->icon) }}" 
                                                 />
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                                ...
                                <td>
                                 ...
                                 <td>
                                     <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                 src="{{ asset('public/Seat/'.$data->image) }}" 
                                                 />
                                            </div>
                               ...
                               <td>
                                    <a href="{{ route('editSeat', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                    @if ($data->status == 1)
                                        <a href="{{ route('hideSeat', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideSeat', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                    <a href="{{ route('deleteSeat', ['id' => $data->id]) }}"
                                        class="btn btn-danger btn-sm">Delete</a>
                               </td>
                            </tr>
                        @endforeach
    ...
    <div class="modal fade" id="create_category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addSeat') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                                <div class="row">
                                    <div class="w-100">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="file" min="100" class="form-control form-control-lg form-control-solid"
                                                name="icon" placeholder="Enter" required />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
         ...
         @php $categories=DB::table('seat_cats')->get(); @endphp
