@extends('layouts.app', ['title' => 'Manage Course'])
            ...
            <div class="d-flex overflow-auto h-55px">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{route('Course')}}">Course Category  </a>
                    </li>
                     <li class="nav-item">
                ...
                <table id="kt_profile_overview_table"
                    ...
                    <thead class="fs-7 text-gray-400 text-uppercase">
                        <tr>
                            ...
                            <th class="min-w-150px">course category</th>
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td>
                                    <!--begin::User-->                                                  <!--begin::Info-->
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="fs-6 text-gray-800 text-hover-primary">@php $da=DB::table('course_cats')->where('id',$data->course_cats_id)->first();  @endphp {{$da->title}}</a>
                               ...
                               <td>
                                    <a href="{{ route('editCourse', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                    @if ($data->status == 1)
                                        <a href="{{ route('hideCourse', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideCourse', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                    <a href="{{ route('deleteCourse', ['id' => $data->id]) }}"
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addCourse') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Courcse Category Title</span>
                                            ...
                                            <select type="text" class="form-control form-control-lg form-control-solid"
                                                name="course_cats_id" placeholder=""require >
                                                @php 

                                                $cat=DB::table('course_cats')->get();
                                                @endphp
                                                @foreach($cat as $cat)
                                    ...
                                    <div class="w-100">
                                       <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Description (Optional)</span>
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="Specify your unique app name"></i>
                                            </label>
                                            <!--end::Label-->
