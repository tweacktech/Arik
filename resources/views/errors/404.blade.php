    ...
    <div class="col">
      <div class="px-5 py-5 mt-5">
        <div class="px-2 py-2 align-middle">
        	<img style="width:60%" src="https://gapaautoparts.com/uploads/b79logo11__1_-removebg-preview.png" />
       
        </div>
        <div class="px-2 py-2">
          <a href="/login" type="button" class="btn btn-outline-info">Login to your Dashboard</a>
        </div>
      </div>
    </div>
</div>
