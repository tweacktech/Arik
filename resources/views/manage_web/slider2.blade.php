@extends('layouts.app', ['title' => 'Home Slider 2'])
											...
											<div class="current" data-kt-stepper-element="content">
												...
												<div class="w-100">
													...
													<div class="pb-10 pb-lg-8">
														<!--begin::Title-->
                                                        <h2 class="fw-bolder d-flex align-items-center text-dark">Home Slider 2</h2>
													...
													<div class="fv-row">
                                                       ...
                                                       <div class="col-md-12">
                                                            <div class="col-md-6" style="float: left">
                                                                <form action="{{ route('update_slider2') }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @method('put')
                                                                    <!--begin::Card-->
                                                                    <div class="card">
