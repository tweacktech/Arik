@extends('layouts.app', ['title' => 'Manage TouristHeader'])
            ...
            <div class="d-flex overflow-auto h-55px">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{route('Tourist')}}">Tourist</a>
                    </li>
                      <li class="nav-item">
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-5 position-relative">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/TouristHeader/'.$data->image) }}" 
                                                 />
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                               ...
                               <td>
                                    <a href="{{ route('editTouristHeader', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                    @if ($data->status == 1)
                                        <a href="{{ route('hideTouristHeader', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideTouristHeader', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                    <a href="{{ route('deleteTouristHeader', ['id' => $data->id]) }}"
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addTouristHeader') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                                <div class="row">
                                    <div class="w-100">
