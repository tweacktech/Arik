@extends('layouts.app', ['title' => 'Manage Cafe'])
  ...
  <div class="modal fade" id="category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    <form method="POST" action="{{route('addCafeCat')}}" >
                         @csrf
                        <div class="row">
                                    <div class="w-100">
                                        <!--begin::Input group-->
                    ...
                    <tbody>
                        @php $tata=DB::table('cafe_cats')->get(); @endphp
                        @foreach($tata as $da)
                        <tr>
                            <td>{{$da->title}}</td>
                            <td> <a href="{{ route('deleteCafeCat', ['id' => $da->id]) }}"
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-5 position-relative">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/Cafe/'.$data->image) }}" 
                                                 />
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                               ...
                               <td>
                                    <a href="{{ route('editCafe', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                    @if ($data->status == 1)
                                        <a href="{{ route('hideCafe', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideCafe', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                    <a href="{{ route('deleteCafe', ['id' => $data->id]) }}"
    ...
    <div class="modal fade" id="create_category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addCafe') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                                <div class="row">
                                    <div class="w-100">
         ...
         @php $categories=DB::table('cafe_cats')->get(); @endphp
