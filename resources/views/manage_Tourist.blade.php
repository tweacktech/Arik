@extends('layouts.app', ['title' => 'Manage Tourist'])
            ...
            <div class="d-flex overflow-auto h-55px">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{route('TouristHeader')}}">Header</a>
                    </li>
                      <li class="nav-item">
        ...
        <div class="modal-dialog modal-dialog-centered ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    <form method="POST" action="{{route('addTouristCat')}}" >
                         @csrf
                        <div class="row">
                                    <div class="w-100">
                                        <!--begin::Input group-->
                    ...
                    <tbody>
                        @php $tata=DB::table('tourist_cats')->paginate(5); @endphp
                        @foreach($tata as $da)
                        <tr>
                            <td>{{$da->title}}</td>
                            <td> <a href="{{ route('deleteTouristCat', ['id' => $da->id]) }}"
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-5 position-relative">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('public/Tourist/'.$data->image) }}" 
                                                 />
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                               ...
                               <td>
                                    <a href="{{ route('editTourist', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a>

                                    @if ($data->status == 1)
                                        <a href="{{ route('hideTourist', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhideTourist', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                    <a href="{{ route('deleteTourist', ['id' => $data->id]) }}"
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addTourist') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                                <div class="row">
                                    <div class="w-100">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <select type="text" class="form-control form-control-lg form-control-solid"
                                                name="location" placeholder=""require />
         @php $categories=DB::table('tourist_cats')->get(); @endphp
