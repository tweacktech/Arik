            ...
            <div class="d-flex overflow-auto h-55px">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{route('ParkHeader')}}">Header</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6" href="{{url('manage-ReservedPark')}}">Booked car park</a>
...
<script>
                ...
                <table id="kt_profile_overview_table"
                    ...
                    <thead class="fs-7 text-gray-400 text-uppercase">
                        <tr>
                            ...
                            <th class="min-w-150px">PARK SPORT_ID</th>
                    ...
                    <tbody class="fs-6">
                        ...
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="fs-6 text-gray-800 text-hover-primary">{{ $data->spot_number }}</a>
                               ...
                               <td>
                                  <!--   <a href="{{ route('editPark', ['id' => $data->id]) }}"
                                        class="btn btn-info btn-sm">Edit</a> -->

                                    @if ($data->status == 1)
                                        <a href="{{ route('hidePark', ['id' => $data->id]) }}"
                                            class="btn btn-danger btn-sm">Hide</a>
                                    @elseif($data->status == 0)
                                        <a href="{{ route('unhidePark', ['id' => $data->id]) }}"
                                            class="btn btn-light btn-sm">Unhide</a>
                                    @endif
                                    <a href="{{ route('deletePark', ['id' => $data->id]) }}"
    ...
    <div class="modal fade" id="create_category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="flex-row-fluid py-lg-5 px-lg-15">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form"
                                enctype="multipart/form-data" action="{{ route('addPark') }}" method="POST">
                                @csrf
                                <!--begin::Step 1-->
                               <div class="row">
                                    <div class="w-100">
         ...
         @php $state=DB::table('state')->get(); @endphp
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="number" min="100" class="form-control form-control-lg form-control-solid"
                                                name="amount" placeholder="Enter" required />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
