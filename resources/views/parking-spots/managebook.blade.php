@extends('layouts.app', ['title' => 'Manage booked Park Sport'])
                ...
                <table id="kt_profile_overview_table"
                    ...
                    <thead class="fs-7 text-gray-400 text-uppercase">
                        <tr>
                            ...
                            <th class="min-w-100px">PARK SPORT_ID</th>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="fs-6 text-gray-800 text-hover-primary">{{ $data->parking_space_id }}   @php $dat=DB::table('parking_spots')->where('id',$data->parking_space_id)->first(); @endphp {{$dat->spot_number}}</a>
